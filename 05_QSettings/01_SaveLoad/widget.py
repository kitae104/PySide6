...
from PySide6.QtCore import Qt  # Import the missing Qt module
from ui_widget import Ui_Widget
from PySide6.QtCore import QSettings
from PySide6.QtWidgets import QColorDialog  # Import the missing QColorDialog module
from PySide6.QtGui import QColor  # Import the missing QColor module
...
class Widget(QWidget, Ui_Widget):
    def __init__(self):
        ...
        self.load_colors_button_clicked() # 로딩후 바로 호출 

    def button_1_clicked(self):
        color = QColorDialog.getColor(
            self.color_list[0], self, "Choose Background Color"
        )
        if color.isValid():
    ...
    def button_2_clicked(self):
        color = QColorDialog.getColor(
            self.color_list[1], self, "Choose Background Color"
        )
        if color.isValid():
    ...
    def button_3_clicked(self):
        color = QColorDialog.getColor(
            self.color_list[2], self, "Choose Background Color"
        )
        if color.isValid():
    ...
    def button_4_clicked(self):
        color = QColorDialog.getColor(
            self.color_list[3], self, "Choose Background Color"
        )
        if color.isValid():
    ...
    def button_5_clicked(self):
        color = QColorDialog.getColor(
            self.color_list[4], self, "Choose Background Color"
        )
        if color.isValid():
    ...
    def button_6_clicked(self):
        color = QColorDialog.getColor(
            self.color_list[5], self, "Choose Background Color"
        )
        if color.isValid():
    ...
    def button_7_clicked(self):
        color = QColorDialog.getColor(
            self.color_list[6], self, "Choose Background Color"
        )
        if color.isValid():
    ...
    def button_8_clicked(self):
        color = QColorDialog.getColor(
            self.color_list[7], self, "Choose Background Color"
        )
        if color.isValid():
    ...
    def button_9_clicked(self):
        color = QColorDialog.getColor(
            self.color_list[8], self, "Choose Background Color"
        )
        if color.isValid():
    ...
    def save_color(self, key, color):
        l_color = QColor(color)  # 색상을 QColor 객체로 변환
        red = l_color.red()  # 빨간색 성분
        green = l_color.green()  # 초록색 성분
        blue = l_color.blue()  # 파란색 성분

        settings = QSettings("Blikoon1", "Setting Colors")  # QSettings 객체 생성
        settings.beginGroup("ButtonColor")  # 그룹 시작
        settings.setValue(key + "r", red)  # 빨간색 성분 저장
        settings.setValue(key + "g", green)  # 초록색 성분 저장
        settings.setValue(key + "b", blue)  # 파란색 성분 저장
        settings.endGroup()  # 그룹 끝

    def load_color(self, key):
        settings = QSettings("Blikoon1", "Setting Colors")
        settings.beginGroup("ButtonColor")
        red = settings.value(key + "r", type=int)
        green = settings.value(key + "g", type=int)
        blue = settings.value(key + "b", type=int)
        settings.endGroup()
